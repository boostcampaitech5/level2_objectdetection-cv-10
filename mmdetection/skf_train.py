...
from mmdet.apis import train_detector # __init__ 에서 추가!
...
def find_work_dir(_model, i, is_train=True):
    """_summary_
    ...
    if is_train:
        work_dir = "baseline/mmdetection/work_dirs/" + _model + f"_trash/fold{i}"
    else:
        work_dir = "baseline/mmdetection/work_dirs/" + _model + f"_implement/fold{i}"
    return work_dir

def init_config_0(cfg, args):
    ...
    # 학습된 파일의 저장 위치 
    cfg.work_dir = find_work_dir(args.config_dir, 0)
...
def init_config_1(cfg, args):
    ...
    cfg.data.train.classes = classes
    cfg.data.train.img_prefix = root
    cfg.data.train.ann_file = root + 'train_split_1.json' # train json 정보
    cfg.data.train.pipeline[2]['img_scale'] = (512,512) # Resize

    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + 'val_split_1.json' # valid json 정보
    ...
    # 학습된 파일의 저장 위치 
    cfg.work_dir = find_work_dir(args.config_dir,1)
...
def init_config_2(cfg, args):
    ...
    cfg.data.train.classes = classes
    cfg.data.train.img_prefix = root
    cfg.data.train.ann_file = root + 'train_split_2.json' # train json 정보
    cfg.data.train.pipeline[2]['img_scale'] = (512,512) # Resize

    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + 'val_split_2.json' # valid json 정보
    ...
    # 학습된 파일의 저장 위치 
    cfg.work_dir = find_work_dir(args.config_dir,2)
...
def init_config_3(cfg, args):
    ...
    cfg.data.train.classes = classes
    cfg.data.train.img_prefix = root
    cfg.data.train.ann_file = root + 'train_split_3.json' # train json 정보
    cfg.data.train.pipeline[2]['img_scale'] = (512,512) # Resize

    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + 'val_split_3.json' # valid json 정보
    ...
    # 학습된 파일의 저장 위치 
    cfg.work_dir = find_work_dir(args.config_dir,3)
...
def init_config_4(cfg, args):
    ...
    cfg.data.train.classes = classes
    cfg.data.train.img_prefix = root
    cfg.data.train.ann_file = root + 'train_split_4.json' # train json 정보
    cfg.data.train.pipeline[2]['img_scale'] = (512,512) # Resize

    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + 'val_split_4.json' # valid json 정보
    ...
    # 학습된 파일의 저장 위치 
    cfg.work_dir = find_work_dir(args.config_dir, 4)
